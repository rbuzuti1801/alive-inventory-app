...
import { ArrowLeftRight, Package, ShoppingCart, Warehouse } from "lucide-react";

export type StockTab = "produtos" | "localizacoes" | "movimentacoes" | "compras";
...
const tabs: { key: StockTab; label: string; icon: React.ReactNode }[] = [
  ...
  { key: "compras", label: "Lista de Compras", icon: <ShoppingCart size={15} /> },
];
